...
api_key = "AIzaSyDiNI9QrtRiPXqIuLx8Ehe1FCqOn0-Bvjs"  # create api key from "https://console.developers.google.com/"
youtube = build('youtube', 'v3', developerKey=api_key)
# to connect MongoDb
conn1 = pymongo.MongoClient(
    "mongodb://mongo1:project1@ac-rovgcjc-shard-00-00.uvbbt44.mongodb.net:27017,ac-rovgcjc-shard-00-01.uvbbt44.mongodb.net:27017,ac-rovgcjc-shard-00-02.uvbbt44.mongodb.net:27017/?ssl=true&replicaSet=atlas-twsbsh-shard-0&authSource=admin&retryWrites=true&w=majority")  # mongodb atlas->sign->database->connect->drivers ->Add your connection string into your application code copy the link and paste it here and give userid and password
...
conn = psycopg2.connect(host="localhost",
                        ...
                        password="12345",
                        port=5432,
                        database="project")  # go to sql tool create database use the same name in database and password to connect sql
cursor = conn.cursor()
